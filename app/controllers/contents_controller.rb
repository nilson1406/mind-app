class ContentsController < ApplicationController
    ...
    def create
        @content = current_user.contents.build(contents_params)
        if @content.save
            associate_tags!
            redirect_to contents_path, notice: 'Content sucessfuly created!'
        else
            render :new
        end
    end
    ...
    def update
        if @content.update(contents_params)
            associate_tags!
            redirect_to contents_path, notice: 'Content sucessfuly updated!'
        else
            render :edit
        end
    end
    ...
    def destroy
        ...
        redirect_to contents_path, notice: 'Content sucessfuly destroyed!'
    end
